...
-- =============================================
CREATE TRIGGER [Global].[CG$AINS_SUNT]
   ON  [Global].[Sub_Unit]
   AFTER INSERT
AS 
BEGIN
...
-- Description:	<Description,,>
-- =============================================
CREATE TRIGGER [Global].[CG$AUPD_SUNT]
   ON  [Global].[Sub_Unit]
   AFTER UPDATE
AS 
BEGIN
...
END
GO
ALTER TABLE [Global].[Sub_Unit] ADD CONSTRAINT [PK_SUNT] PRIMARY KEY CLUSTERED  ([BUNT_DEPT_ORGN_CODE], [BUNT_DEPT_CODE], [BUNT_CODE], [CODE]) ON [BLOB]
GO
ALTER TABLE [Global].[Sub_Unit] ADD CONSTRAINT [FK_SUNT_BUNT] FOREIGN KEY ([BUNT_DEPT_ORGN_CODE], [BUNT_DEPT_CODE], [BUNT_CODE]) REFERENCES [Global].[Base_Unit] ([DEPT_ORGN_CODE], [DEPT_CODE], [CODE]) ON DELETE CASCADE
GO
