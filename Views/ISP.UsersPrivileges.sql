...
CREATE VIEW [ISP].[UsersPrivileges]
AS
SELECT     DataGuard.[User].ID AS UserID, DataGuard.[User].TitleEn AS UserEnName, DataGuard.[User].IsVisible AS UserVisible, DataGuard.[User].IsLock AS UserLock, 
                      ...
                      ISP.Privilege.TitleEn AS PrivilegeName, ISP.Privilege.IsVisible AS PrivilegeVisible, ISP.Privilege.ShortCut AS PrivilegeID
