...
SET ANSI_NULLS ON
GO
CREATE VIEW [DataGuard].[AllRolesPrivileges]
AS
...
Begin DesignProperties = 
   ...
   End
End
', 'SCHEMA', N'DataGuard', 'VIEW', N'AllRolesPrivileges', NULL, NULL
GO
DECLARE @xp int
SELECT @xp=1
EXEC sp_addextendedproperty N'MS_DiagramPaneCount', @xp, 'SCHEMA', N'DataGuard', 'VIEW', N'AllRolesPrivileges', NULL, NULL
GO
