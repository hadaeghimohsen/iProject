...
CREATE VIEW [Report].[UsersPrivileges]
AS
SELECT     DataGuard.[User].ID AS UserID, DataGuard.[User].TitleEn AS UserEnName, DataGuard.[User].IsVisible AS UserVisible, DataGuard.[User].IsLock AS UserLock, 
                      ...
                      Report.Privilege.TitleEn AS PrivilegeName, Report.Privilege.IsVisible AS PrivilegeVisible, Report.Privilege.ShortCut AS PrivilegeID
