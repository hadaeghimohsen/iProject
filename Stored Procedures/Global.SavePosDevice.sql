...
BEGIN   
   ...
   BEGIN TRAN SavePosDevice_Tran
      ...
      WHEN NOT MATCHED THEN 
         INSERT (PSID, BANK_TYPE, BNKB_CODE, BNKA_ACNT_NUMB, SHBA_CODE, POS_DESC, POS_STAT, POS_DFLT, SEND_AMNT_EDIT, SEND_DATA_ON_DEVC, FILL_RSLT_DATA, POS_CNCT_TYPE, IP_ADRS, COMM_PORT, BAND_RATE, PRNT_SALE, PRNT_CUST)
         VALUES (S.PSID, @BankType, @BnkbCode, @BnkaAcntNumb, @ShbaCode, @PosDesc, @PosStat, @PosDflt, '001', '002', '002', @PosCnctType, @IPAdrs, @CommPort, @BandRate, @PrntSale, @PrntCust)
      WHEN MATCHED THEN
         UPDATE SET
